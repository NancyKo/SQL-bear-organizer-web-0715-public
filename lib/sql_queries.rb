...
def selects_most_prominent_color_and_returns_with_count
  # "SELECT color, COUNT (*) AS most_prominent FROM bears GROUP BY color HAVING most_prominent = 3 ;"
  "SELECT color, COUNT (*) AS most_prominent FROM bears GROUP BY color ORDER BY most_prominent DESC LIMIT 1"
end
